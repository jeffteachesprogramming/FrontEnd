...
function validateAndCalculateHourly()
{
    ...
    const hoursResult = validateNumericInput(
    ...
    {
        return {success: false, message: hoursResult.message, focus: hourlyWorkedInput};
    }
    ...
    if (!rateResult.valid)
    {
        return {success: false, message: rateResult.message, focus: hourlyRateInput};
    }
