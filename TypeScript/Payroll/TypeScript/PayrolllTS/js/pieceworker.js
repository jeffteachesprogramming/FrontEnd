...
function calculatePieceWorkerGrossPay(pieces, price) {
    ...
    const message = `${pieces} pieces made x $${price.toFixed(2)} per piece`;
...
function validateAndCalculatePieceWorker() {
    ...
    const piecesResult = validateNumericInput(piecesMadeInput, "Pieces Made", MINPIECES, MAXPIECES);
    ...
    const priceResult = validateNumericInput(pricePerPieceInput, "Price Per Piece", MINPPP, MAXPPP);
    //  If invalid, return with error message
...
//# sourceMappingURL=pieceworker.js.map